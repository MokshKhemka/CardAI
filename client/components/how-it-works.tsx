    ...
    <section className="py-16 border-b border-notebook-line bg-white blocky-section blocky-card">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <h2 className="heading-handwritten mb-8 text-center text-pencil-lead">How CardAI Works</h2>
        ...
        <div className="mt-12 flex justify-center">
          <button className="bg-chalkboard-green hover:bg-chalkboard-green/90 text-white font-medium px-8 py-3 rounded-md transition-colors flex items-center button-playful">
            Try It Now
...
function StepCard({ number, title, description }: { number: number; title: string; description: string }) {
  return (
    <div className="relative p-6 bg-white border blocky-card">
      <div className="absolute -top-3 -left-3 w-8 h-8 bg-apple-red flex items-center justify-center font-bold text-white" style={{ borderRadius: 0 }}>
        {number}
      </div>
